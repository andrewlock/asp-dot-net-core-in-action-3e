    ...
    public partial class CreateSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExchangeRateValuesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Rate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Value = table.Column<decimal>(type: "decimal(20,12)", precision: 20, scale: 12, nullable: false),
                    ExchangeRatesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
